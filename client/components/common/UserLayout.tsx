  ...
  const renderList = () => {
    if (!data)
      return (
        ...
        >
          <Text size={16}>{translations.common.loading}</Text>
        </Row>
      );
    ...
    if (data && data.items.length === 0)
      return (
        <Row
          ...
          css={{ h: '100%', p: 10, position: 'absolute' }}
        >
          <Text size={16}>لم يتم العثور على منتجات</Text>
        </Row>
      );
    ...
    <>
      <div className='search-container'>
        <Input
          ...
          placeholder={translations.filters.sortBy}
        />
          ...
          {session ? (
            <Dropdown placement='bottom-right'>
              ...
              >
                ...
                <Dropdown.Item key='profile'>{translations.profile.title}</Dropdown.Item>
